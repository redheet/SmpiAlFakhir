        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="lg:pr-10">
            ...
            <p className="mb-6 text-gray-900">
              SMP Islam Modern Al Fakhir didirikan oleh Bpk. Deni Irawan, M.Pd pada bulan Oktober 2023. Arti nama Al-Fakhir artinya adalah kemuliaan, kebesaran
              atau kebanggaan dengan harapan sekolah ini bisa menjadi sekolah yang besar dan juga setiap siswa-siswi yang bersekolah di sekolah ini menjadi
              sosok yang membanggakan bagi dirinya sendiri, keluarga, juga masyarakat.
            </p>
