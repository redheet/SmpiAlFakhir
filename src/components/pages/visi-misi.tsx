        ...
        <div className="mx-auto max-w-7xl py-16 px-6 sm:py-24 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-xl text-xl text-gray-500">
              Sebagai ruang formal dalam membentuk generasi Islami Modern yang
              berpengetahuan luas, berakhlak baik dan dapat menerapkan ilmu
              pengetahuan di berbagai aspek kehidupan untuk kesuksesan hidup.di
