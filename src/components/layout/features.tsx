...
const Features = () => {
  ...
  const css = `.nft-filters li.active button {
        ...
        <div className="container">
          <div className="mb-8 flex flex-col items-center gap-5 md:mb-0 md:flex-row md:items-start md:justify-between">
            ...
            <div className="mt-2 flex items-center justify-end gap-4">
              <a href="/blog" className="text-sm font-extrabold text-black transition hover:text-secondary dark:text-white dark:hover:text-secondary">
                View All
              </a>
              <button
                type="button"
                  ...
                  <div className="rounded-[32px] bg-white px-4 py-8 dark:bg-gray-dark lg:p-8">
                    ...
                    <div className="relative mt-12 pl-5 text-black dark:text-white md:mt-20">
                      ...
                      <p className="text-sm font-semibold italic">
                        We partnered with Fluid Studios to design our website. We found them incredibly helpful and patient as we really didn't know what we
                        wanted. Greg met with us on numerous occasions and we found the whole process a great experience. We ended up with a website we loved. I
                        would definitely recommend Fluid Studios - you won't be disappointed.
                      </p>
